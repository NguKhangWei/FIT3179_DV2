...
const silver = {
  ...
  "transform": [
    ...
    {
      "calculate": "datum.total_awards > 0 ? datum.total_silver / datum.total_awards : 0",
      "as": "silver_ratio"
    }
  ],
  "mark": "rect",
...
const bronze = {
  ...
  "transform": [
    ...
    {
      "calculate": "datum.total_awards > 0 ? datum.total_bronze / datum.total_awards : 0",
      "as": "bronze_ratio"
    }
  ],
  "mark": "rect",
...
vegaEmbed("#gold", gold, { mode: "vega-lite" })
.then(console.log)
.catch(console.warn);

vegaEmbed("#silver", silver, { mode: "vega-lite" })
.then(console.log)
.catch(console.warn);

vegaEmbed("#bronze", bronze, { mode: "vega-lite" })
.then(console.log)
.catch(console.warn);